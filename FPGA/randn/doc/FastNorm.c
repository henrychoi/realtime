	DONT  USE  THIS  CODE !!!!   A SUBTLE CORRELATION HAS BEEN DISCOVERED.
USE  fastnorm2.c,  fastnorm2.h  INSTEAD.  THESE APPEAR TO OVERCOME THE DEFECT
BUT

	>>>>>>>>>>>>>>>>   PLEASE READ THE COMMENTS IN FastNorm2.c   <<<<<<<<


	This file is retained for historical reasons only.
