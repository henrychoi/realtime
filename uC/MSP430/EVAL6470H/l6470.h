...
#define dSPIN_Release_SW(action, direction) \
	dSPIN_Write_Byte(dSPIN_RELEASE_SW | action | direction)
#define dSPIN_Go_Home() dSPIN_Write_Byte(dSPIN_GO_HOME)
#define dSPIN_Go_Mark() dSPIN_Write_Byte(dSPIN_GO_MARK)
#define dSPIN_Reset_Pos() dSPIN_Write_Byte(dSPIN_RESET_POS)
#define dSPIN_Reset_Device() dSPIN_Write_Byte(dSPIN_RESET_DEVICE)
#define dSPIN_Soft_Stop() dSPIN_Write_Byte(dSPIN_SOFT_STOP)
#define dSPIN_Hard_Stop() dSPIN_Write_Byte(dSPIN_HARD_STOP)
#define dSPIN_Soft_HiZ() dSPIN_Write_Byte(dSPIN_SOFT_HIZ)
#define dSPIN_Hard_HiZ() dSPIN_Write_Byte(dSPIN_HARD_HIZ)
#define dSPIN_Nop() dSPIN_Write_Byte(dSPIN_NOP)
#define dSPIN_Busy_HW() !(P2IN & BIT6)
#define dSPIN_Busy_SW() !(dSPIN_Get_Status(id) & dSPIN_STATUS_BUSY)
#define dSPIN_Alarm() !(P2IN & BIT7)
