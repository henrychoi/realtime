...
void QS_sig_dict(int const sig, void const * const obj,
                 char const *name);
...
void QS_usr_dict(int const rec,
...
#define QS_SIG_DICTIONARY(sig_, obj_) do { \
    ...
    { \
        static char const sig_name_[] = #sig_; \
...
#define QS_OBJ_DICTIONARY(obj_) do { \
    ...
    { \
        static char const obj_name_[] = #obj_; \
...
#define QS_FUN_DICTIONARY(fun_) do { \
    ...
    { \
        static char const fun_name_[] = #fun_; \
